        ...
        case 1:
            do {
                do {
                    ...
                    printf("Elija quien sube al bote?\n 1)lobo\n 2)conejo\n 3)zanahoria\n elija 2 opciones");
                    printf("\nopcion 1: ");
                    scanf("%d", &op1);
                    getchar();
                    printf("\nopcion 2: ");
                ...
                if (op1 == 1 && op2 == 3) {/*primer viaje*/
                    ...
                    do {
                        ...
                        printf("Elejiste al lobo y a la zanahoria, suben a al bote ");

                        printf("Elija quien baja del bote?\n 1)lobo\n 2)zanahoria\n 3)ambos\n elija 1 opcion");
                        printf("\nopcion: ");
                        scanf("%d", &op3);
                        if (op3 == 1) {
                            cont++;
                            ...
                            do {
                                ...
                                if (op1 == 1 && op2 == 2 || op1 == 2 && op2 == 1) {
                                    ...
                                    if (op1 == 2 && op2 == 2) {
                                        printf("El juego no puede continuar ¬¬ \n Volver a empezar\n\n");
                                        x = 0;
                                    } else {
                                        cont++;
                                        x = 1;
                                        do {
                                            ...
                                            printf("Se baja la zanahoria y el conejo cruza\n"); /*3º viaje*/
                                            ...
                                            if (op1 == 1 && op2 == 2 || op1 == 2 && op2 == 1) {
                                                ...
                                                if (op1 == 2 && op2 == 2) {
                                                    ...
                                                    do {
                                                        ...
                                                        printf("Se baja el conejo y el lobo cruza\n"); /*4º viaje*/
                                                        ...
                                                        if (op1 == 1 && op2 == 2 || op1 == 2 && op2 == 2) {
                                                            ...
                                                            do {
                                                                ...
                                                                printf("Se sube la zanahoria y el lobo cruzan ambos\n"); /*5º viaje*/
                                                                printf("baja el lobo?  1)Si 2)No\n");
                                                                scanf("%d", &op1);
                                                                printf("baja la zanahoria? 1Si 2)No\n");
                                                                scanf("%d", &op2);
                                                                if (op1 == 1 && op2 == 2 || op1 == 2 && op2 == 1) {
                                                                    printf("se acabo el juego realizo mas de 5 viajes ¬¬ \n Volver a empezar\n\n");
                                                                    x = 0;
                                                                    cont++;
                                                                } else {
                                                                    printf("Se acabo el juego lo lograste");
                                                                    cont++;
                                                                    x = 1;
                                                                }
                                                            } while (x == 0);
                            ...
                            if (op3 == 2) {
                                    ...
                                    if (op1 == 1 && op2 == 2 || op1 == 2 && op2 == 1) {
                                        ...
                                        if (op1 == 2 && op2 == 2) {
                                            ...
                                            do {
                                                ...
                                                printf("Se baja el lobo y el conejo cruza\n"); /*3º viaje*/
                                                printf("baja el conejo?  1)Si 2)No\n");
                                                scanf("%d", &op1);
                                                printf("sube la zanahoria? 1Si 2)No\n");
                                                scanf("%d", &op2);
                                                if (op1 == 1 && op2 == 2 || op1 == 2 && op2 == 1) {
                                                    ...
                                                    if (op1 == 2 && op2 == 2) {
                                                        ...
                                                        do {
                                                            ...
                                                            printf("Se baja el conejo y la zanahoria cruza\n"); /*4º viaje*/
                                                            printf("baja la zanahoria?  1)Si 2)No\n");
                                                            scanf("%d", &op1);
                                                            printf("sube el lobo? 1Si 2)No\n");
                                                            scanf("%d", &op2);
                                ...
                                printf("Se bajan ambos nadie se devuelve\n Volver a empezar\n\n");
                                x = 0;
                            }
                        }
                    }/*fin do*/ while (x == 0);
